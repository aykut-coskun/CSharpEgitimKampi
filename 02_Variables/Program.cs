...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alınan Ürün: Elma - " +"Birim Fiyat: " + appleTotalPrice + " - Gramaj: " 
            //    + appleGram + " - Toplam Tutar: " + appleTotalPrice);

            //Console.WriteLine("Alınan Ürün: Portkal - " + "Birim Fiyat: " + orangePrice + " - Gramaj: " 
            ...
            //Console.WriteLine();
            //Console.WriteLine("Toplam Ödemeniz Greken Tutar: " + totalPrice);
